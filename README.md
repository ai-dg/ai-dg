...
▸ [**Learn2Slither**](z) - Reinforcement Learning exploration: grid-world agent for a Snake-like game (ε-greedy policies, reward shaping, value updates). Experimental RL sandbox.  
